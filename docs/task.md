...
> Оригинальный текст тестового задания MTBank, каким он пришёл в шаблоне
> репозитория. Документация решения — в [README.md](../README.md).
...
Сгенерируйте звонок оператор/клиент 2–4 минуты по сценарию из [`docs/sample-dialog.md`](sample-dialog.md):
